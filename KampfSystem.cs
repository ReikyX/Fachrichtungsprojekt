    ...
    internal class KampfSystem
    {
        public static void CharakterVsGegner(Charakter meinCharakter, Gegner gegner, string text)
        {
            ...
            if (meinCharakter.Hp > 0)
            {
                ...
                {
                    if(meinCharakter.Hp >= 950){meinCharakter.Hp = meinCharakter.MaxHp;}
                    else {meinCharakter.Hp += 50;}
                    if(meinCharakter.Mana >= 980) { meinCharakter.Mana = meinCharakter.MaxMana; }
                    else { meinCharakter.Mana += 20; }
                    if (meinCharakter.Level == 200) { meinCharakter.Level = meinCharakter.MaxLevel; }
                    else { meinCharakter.Level++;}
